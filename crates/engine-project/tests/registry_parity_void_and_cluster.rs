//! Parity: Registry `void_and_cluster` vs the ordered-dither path.
...
#[test]
fn registry_parity_void_and_cluster() {
    let params = vac_params();
    ...
    let algo = registry
        .get(AlgorithmId::new("void_and_cluster"))
        .expect("void_and_cluster registered");
    ...
    filter.algorithm_id = Some("void_and_cluster".into());
...
#[test]
fn void_and_cluster_matrix_is_blue_noise_permutation() {
