//! Parity: Registry `dispersed_dot_ordered` vs the ordered-dither path.
...
fn dispersed_params() -> DitherParamsV2 {
    DitherParamsV2 {
        mode: DitherModeV2::DispersedDotOrdered,
        levels: 4,
        threshold_scale: 1.0,
        pixel_size: 1,
...
#[test]
fn registry_parity_dispersed_dot_ordered() {
    let params = dispersed_params();
    ...
    filter.algorithm_id = Some("dispersed_dot_ordered".into());
