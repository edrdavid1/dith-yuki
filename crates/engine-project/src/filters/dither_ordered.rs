...
pub fn apply_ordered_with_cache_into(
    ...
    if matches!(params.mode, DitherModeV2::LineScreen) {
        return crate::filters::line_screen::apply_line_screen_into(
            tile,
            coord,
            params,
            palette_cache,
    ...
    if matches!(params.mode, DitherModeV2::VoronoiStipple) {
        return crate::filters::voronoi_stipple::apply_voronoi_stipple_into(
            tile,
            coord,
            params,
            palette_cache,
    ...
    if matches!(params.mode, DitherModeV2::RandomDotStipple) {
        return crate::filters::random_dot_stipple::apply_random_dot_stipple_into(
            tile,
            coord,
            params,
            palette_cache,
