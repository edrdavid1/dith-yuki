...
/// Ulichney void-and-cluster blue-noise ordered dither.
pub struct VoidAndCluster;

impl FilterAlgorithm for VoidAndCluster {
    fn id(&self) -> AlgorithmId {
        AlgorithmId::new("void_and_cluster")
    }
    ...
    fn apply(
        ...
        params.mode = DitherModeV2::VoidAndCluster;
